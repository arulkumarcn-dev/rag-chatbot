...
- **Multi-Format Support**: PDF, CSV, TXT, Images, and YouTube video transcripts
...
- **LLM Integration**: OpenAI GPT-4 and embeddings support (easily extendable to Gemini/Grok)
